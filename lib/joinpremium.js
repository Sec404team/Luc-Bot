const joinpremium = (pushname, prefix, getLevelingLevel, getLevelingXp, sender, reqXp, _registered, uangku, role, f, g, h, i, j, k, l, m, fake, prema, num, ow, dev) => { 
return ` \`\`\`
➣「${fake}」
╔═════════════════❍
...
║${f}Sewa Sebulan   : 30k
║${f}Sewa 3 bulan   : 50k
║${f}Sewa selamanya : 100K
║
║${f}DONASI:
║${f}Gopay:0895602592430
║${f}Dana:0895602592430
║${f}Ovo:0895602592430
║
║${f}Payment:
║${f}Gopay
...
exports.joinpremium = joinpremium
