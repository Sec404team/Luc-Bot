const akuarium = (pushname, prefix, getLevelingLevel, getLevelingXp, sender, reqXp, heartbars, kurakuraa, guritaa, cumicumia, udanga, lobstera, kepitingaa, pufferfisha, ikana, ikan2a, lumbalumbaa, pausa, paus2a, hiua, seadoga, checkLimituser, checkpremLimituser, potionpointa, megapotionpointa, checkHealuser, _registered, uangku, role, f, g, h, i, j, k, l, m, fake, prema, num, ow, dev) => { 
return ` \`\`\`		
➣「${fake}」
╔═════════════════❍
