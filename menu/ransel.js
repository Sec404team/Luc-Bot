...
║${f}${jamurpointa}    ${f}${daun2pointa}
║${f}${daunmaplepointa}    ${f}${clover3pointa}
║${f}${kayupointa}    ${f}${clover4pointa}
║${f}${bibitpointa}    ${f}${puzzlepointa}
╚═════════════════❍
➣「NOTE」
╔═════════════════❍
